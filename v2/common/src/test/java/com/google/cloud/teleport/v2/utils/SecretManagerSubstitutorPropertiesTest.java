...
/**
 * Unit and integration tests for com.google.cloud.secrethelper.SecretManagerStringSubstitutor.
 */
@RunWith(MockitoJUnitRunner.class)
public class SecretManagerSubstitutorPropertiesTest {

  static final String PROPERTIES_STRING = ""
  ...
  public void testSecretManagerSubstitutorProperties() throws IOException {
    String template = String.format(PROPERTIES_STRING,
        secretName,
        secretName);
