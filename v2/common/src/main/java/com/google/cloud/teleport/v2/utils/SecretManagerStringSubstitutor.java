...
/**
 * A class that provides a StringSubstitutor. It replaces template strings with either a Secret
 * Manager payload or writes the payload to a file, and substitutes the path to the file.
 */
