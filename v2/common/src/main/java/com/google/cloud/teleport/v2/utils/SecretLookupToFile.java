...
/**
 * com.google.cloud.secrethelper.SecretLookupToFile provides an implementation of StringLookup that
 * returns a Secret Manager secret payload for the provided key.
 */
